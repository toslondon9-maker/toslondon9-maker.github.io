...
export function renderFooter(options = {}) {
  ...
  const social = `<section class="siteFooter__social" aria-labelledby="footer-social-heading"><p class="eyebrow" id="footer-social-heading" data-i18n="footer.socialHeading">${escapeHtml(t("footer.socialHeading", language))}</p><p data-i18n="footer.socialBody">${escapeHtml(t("footer.socialBody", language))}</p><div class="siteFooter__socialLinks"><a href="https://www.linkedin.com/in/tariq-saddique-0648bb436/" target="_blank" rel="noopener noreferrer" data-social-platform="linkedin" aria-label="LinkedIn">LinkedIn</a><a href="https://www.instagram.com/tariq_uyp/" target="_blank" rel="noopener noreferrer" data-social-platform="instagram" aria-label="Instagram">Instagram</a><a href="https://www.tiktok.com/@tariq_uyp" target="_blank" rel="noopener noreferrer" data-social-platform="tiktok" aria-label="TikTok">TikTok</a><a href="https://www.facebook.com/profile.php?id=61594378315784" target="_blank" rel="noopener noreferrer" data-social-platform="facebook" aria-label="Facebook">Facebook</a><a href="https://www.youtube.com/channel/UCFO-egu-r2RCtqHywd4lU8A" target="_blank" rel="noopener noreferrer" data-social-platform="youtube" aria-label="YouTube">YouTube</a></div></section>`;
