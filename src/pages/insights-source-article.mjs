...
export function sourceArticlePage({ data, language = "en", id, metaKey, pdf }) {
  ...
  const publicationDate = ["insights.people", "insights.foundationDevelopment", "insights.foundationFirstStep", "insights.foundationQA"].includes(metaKey) ? "2026-09-11" : metaKey === "insights.personalCoaching" ? "2026-09-13" : "2026-09-10";
