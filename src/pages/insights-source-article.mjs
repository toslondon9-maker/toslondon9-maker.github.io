...
export function sourceArticlePage({ data, language = "en", id, metaKey, pdf }) {
  ...
  const publicationDate = ["insights.people", "insights.foundationDevelopment", "insights.foundationFirstStep", "insights.foundationQA"].includes(metaKey) ? "2026-09-11" : "2026-09-10";
  const publicationKey = publicationDate === "2026-09-11" ? "insights.publicationDatePeople" : "insights.publicationDate";
  ...
  const routeKey = { "insights.journey": "insightsJourney", "insights.lawAttraction": "insightsLawAttraction", "insights.people": "insightsPeople", "insights.foundationDevelopment": "insightsFoundationDevelopment", "insights.foundationFirstStep": "insightsFoundationFirstStep", "insights.foundationQA": "insightsFoundationQA" }[metaKey];
