...
export function sourceArticlePage({ data, language = "en", id, metaKey, pdf }) {
  ...
  return { route: data.routes[metaKey === "insights.journey" ? "insightsJourney" : "insightsLawAttraction"], language, title: heading, description: t(`${metaKey}.metaDescription`, language), titleKey: `${metaKey}.heading`, descriptionKey: `${metaKey}.metaDescription`, body, structuredData: [{ "@type": "Article", headline: heading, description: t(`${metaKey}.metaDescription`, language), mainEntityOfPage: canonical, author: { "@type": "Organization", name: "Unleash Your Power" }, publisher: { "@id": "https://unleashyourpowerwithtariq.com/#organization" } }], scripts: [] };
}
