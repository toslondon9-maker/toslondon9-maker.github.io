...
function markdownToHtml(markdown, { skipCtas = false } = {}) {
  ...
  for (const line of lines) {
    ...
    if (skipCtas && /^\**\[(START THE FREE SEVEN-DAY EXPERIENCE|EXPLORE THE MASTER KEY SYSTEM|BOOK A FREE 15-MINUTE CALL)\]\**$/.test(line.trim())) { flush(); continue; }
