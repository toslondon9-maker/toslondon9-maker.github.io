...
function bookingCta(number, language) {
  return `<a class="button--primary" href="${bookingCallHref(number)}" target="_blank" rel="noopener noreferrer" data-i18n="cta.bookCall">${escapeHtml(t("cta.bookCall", language))}</a>`;
}
