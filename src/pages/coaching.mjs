...
function coachingDecision(language) {
  if (language !== "en") return "";
  return `<section class="coachingDecision section"><div class="coachingDecision__intro"><p class="eyebrow">IS THIS FOR YOU?</p><h2>A guided practice for people ready to apply, not just consume</h2><p>The programme is designed for people who want a structured way to study the Master Key System and connect the weekly principles to real decisions, habits and responsibilities.</p></div><div class="coachingDecision__grid"><article><span>01</span><h3>You are ready if...</h3><ul><li>You want a clear weekly structure.</li><li>You are willing to practise between sessions.</li><li>You want honest reflection, not hype.</li></ul></article><article><span>02</span><h3>What you receive</h3><ul><li>A progressive 24-week study journey.</li><li>Guidance, reflection and accountability.</li><li>Practical application to your real life.</li></ul></article><article><span>03</span><h3>What this is not</h3><ul><li>Not a guaranteed-results programme.</li><li>Not passive motivation or manifestation promises.</li><li>Not medical, psychological or financial advice.</li></ul></article></div></section>`;
}

function coachingNextSteps(language, route, startFreeRoute) {
  if (language !== "en") return "";
  return `<section class="coachingNextSteps section" aria-labelledby="coaching-next-step-title"><div class="coachingNextSteps__intro"><p class="eyebrow">FROM ENQUIRY TO WEEK 1</p><h2 id="coaching-next-step-title">A simple next step. No pressure.</h2><p>You do not need to commit before you understand the programme. Start with a conversation, ask what matters to you and decide from there.</p></div><ol class="coachingNextSteps__steps"><li><strong>01</strong><div><h3>Tell Tariq what you want to work on</h3><p>Share your goal, what is getting in the way and what you want to understand about the programme.</p></div></li><li><strong>02</strong><div><h3>Check the fit</h3><p>Clarify the structure, expectations and whether the 24-week journey is appropriate for you.</p></div></li><li><strong>03</strong><div><h3>Begin with a clear Week 1</h3><p>If you decide to continue, start with the first lesson, one practice and one real-world application.</p></div></li></ol><div class="coachingNextSteps__actions"><a class="button--primary" href="${route}">ENQUIRE ABOUT COACHING</a><a class="button--secondary" href="${startFreeRoute}">START FREE FOR 7 DAYS</a></div></section>`;
}
