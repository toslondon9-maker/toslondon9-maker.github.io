...
export function mksLineagePage(data = siteData, language = "en") {
  const body = `<main class="mksLineagePage" id="main-content">
    ...
    <div class="mksLineage__content">
      ...
      ${section("YOUR GUIDE", "Tariq Saddique — Your Guide Through the 24-Week Journey", "Tariq guides students through the weekly lessons, exercises, reflection, practical application and accountability that support consistent study. He is not presenting himself as Charles F. Haanel or Helmar Rudolph; he offers his own independent Unleash Your Power study and coaching programme.", "", { src: "/images/lineage/tariq-saddique.png", alt: "Tariq Saddique", side: "right" })}
