...
import { renderFoundationNextStep, renderWhatHappensNext } from "../conversion-components.mjs";
...
export function renderStartFree({ language = "en" } = {}) {
  return renderStartFreeBody({ language }).replace(
    '<main class="sevenDayDashboard" id="main-content">',
    `<main class="sevenDayDashboard" id="main-content">${renderWhatHappensNext({ language, data: siteData, startHref: "#start-free-registration" })}`,
  );
}
