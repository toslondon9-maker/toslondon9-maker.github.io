...
const workbookPaths = Object.freeze({
  english: "/downloads/seven-day-experience-workbook-en.pdf",
  spanish: "/downloads/experiencia-siete-dias-cuaderno-es.pdf",
});
