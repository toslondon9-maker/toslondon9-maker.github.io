...
export function renderHome({ language = "en" } = {}) {
  ...
  return `<main class="home"><section class="homeHero" data-home-section="hero"><div class="homeHero__copy">${copy("home.hero.eyebrow", language, "p", "eyebrow")}${copy("route.home.heading", language, "h1")}${copy("route.home.purpose", language, "h2", "homeHero__subheading")}${copy("home.hero.change", language, "p", "homeHero__change")}<div class="homeActions">${cta(siteData.routes.startFree, "route.home.action", language, "primary", "routeShell__action")}${cta(siteData.routes.masterKeySystem, "home.cta.exploreJourney", language, "secondary")}</div>${copy("home.hero.microcopy", language, "p", "homeHero__microcopy")}</div><div class="homeHero__visual"><picture><source srcset="/images/tariq-happiness-harmony-720.webp" type="image/webp"><img src="${heroImage}" width="1088" height="1445" fetchpriority="high" decoding="async" alt="${escapeHtml(t("home.hero.alt", language))}" data-i18n-alt="home.hero.alt"></picture></div></section>${renderLineage(language)}${renderTaster(language)}<section class="homeSection homeMasterKey" data-home-section="master-key"><div class="homeSection__inner homeMasterKey__inner">${copy("home.masterKey.eyebrow", language, "p", "eyebrow")}${copy("home.masterKey.title", language, "h2")}${copy("home.masterKey.body", language, "p", "homeSection__intro")}<ol class="homeMasterKey__phases">${renderEducationPhases(language)}</ol>${copy("home.masterKey.progressive", language, "p", "homeMasterKey__progressive")}${cta(siteData.routes.masterKeySystem, "home.masterKey.cta", language, "text")}</div></section>${renderTestimonials()}${renderCoaching(language)}<section class="homeSection homeNext section--night" data-home-section="next-step"><div class="homeSection__inner">${copy("home.next.eyebrow", language, "p", "eyebrow")}${copy("home.next.title", language, "h2")}${copy("home.next.body", language, "p", "homeSection__intro")}<div class="homeActions">${cta(siteData.routes.startFree, "home.cta.startFree", language)}${cta(siteData.routes.contact, "home.cta.book", language, "secondary")}</div></div></section></main>`;
}
