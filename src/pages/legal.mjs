...
function privacyContent(data) {
  return [
    ...
    section("Cookies and Analytics", `<p>Google Analytics 4 is used only after you choose to accept optional Analytics. It measures page visits, successful Free 7-Day registrations after the registration service confirms storage, and clicks that begin a PayPal payment. No names, emails, WhatsApp numbers, goals, difficulties or form-answer content is sent to Google Analytics. Advertising and remarketing signals remain disabled. You can decline, withdraw or change your choice at any time using Analytics preferences in the footer. Some browser features use local storage rather than cookies to remember progress or a referral code on your device. Third-party websites you visit through a link may use their own cookies and analytics under their own policies.</p>`),
