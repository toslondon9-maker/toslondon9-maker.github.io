...
function privacyContent(data) {
  return [
    ...
    section("Seven-Day Registration", `<p>When you register for the Free 7-Day Experience, we collect your first name, surname, email address, WhatsApp number and required WhatsApp-contact consent. You may optionally share your goals and current difficulty to help Tariq provide relevant follow-up. We also record your yes-or-no choice about optional email marketing; it is not required. The registration is processed through a dedicated service and stored in a private Google Sheet so Tariq can deliver relevant follow-up.</p>`),
    ...
    section("Cookies and Analytics", `<p>Google Analytics 4 is used only after you choose to accept optional Analytics. It measures page visits and anonymous journey actions such as article CTA clicks, opening the Free 7-Day experience, opening Day 1, completing Day 7, choosing WhatsApp, and beginning a Foundation or complete-journey checkout; successful Free 7-Day registrations are recorded only after the registration service confirms storage. No names, emails, WhatsApp numbers, goals, difficulties or form-answer content is sent to Google Analytics. Referral codes are not sent to Google Analytics either. Advertising and remarketing signals remain disabled. You can decline, withdraw or change your choice at any time using Analytics preferences in the footer. Some browser features use local storage rather than cookies to remember progress or a referral identifier on your device. Third-party websites you visit through a link may use their own cookies and analytics under their own policies.</p>`),
    ...
    section("Referral and External Links", `<p>A referral code may be stored locally in your browser for up to 60 days on a first-touch basis. If you complete the Free 7-Day Experience registration, the code may be included with that registration so referrals can be handled manually. External links are provided for convenience and do not make us responsible for third-party content or privacy practices.</p>`),
    section("Data Retention", `<p>We keep personal information only for as long as reasonably necessary for the purpose for which it was provided, including responding to enquiries, supporting an agreed service, resolving disputes, and meeting legal or administrative requirements. You can request access, correction or deletion by contacting ${email(data)}. Registration records are reviewed monthly for completed deletion requests and records no longer needed for an active relationship or legal or administrative reason.</p>`),
