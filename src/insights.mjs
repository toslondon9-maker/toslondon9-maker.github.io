...
export function renderInsightCard({ id, href, language = "en" }) {
  ...
  const number = { personalCoaching: "01", imagineMeditation: "02", haanelBiography: "03", foundationDevelopment: "04", foundationFirstStep: "05", foundationQA: "06", people: "07", journey: "08", lawAttraction: "09", introduction: "10", principles: "11", worldWithin: "12" }[id];
  const pdfs = { personalCoaching: "advantages-personal-master-key-system-coaching.pdf", imagineMeditation: "imagine-combining-deep-meditation-personal-development.pdf", haanelBiography: "who-was-charles-f-haanel-life-and-legacy.pdf", foundationDevelopment: "foundation-stage-development.pdf", foundationFirstStep: "foundation-first-step.pdf", foundationQA: "foundation-stage-questions-and-answers.pdf", people: "10-people-connected-to-the-master-key-system.pdf", introduction: "charles-haanel-master-key-system-introduction.pdf", principles: "eight-principles-master-key-system.pdf", worldWithin: "world-within-and-world-without.pdf", journey: "master-key-system-24-week-journey.pdf", lawAttraction: "law-of-attraction-week-18.pdf" };
  const pdf = pdfs[id];
  const date = ["personalCoaching", "imagineMeditation"].includes(id) ? "2026-09-13" : id === "haanelBiography" ? "2026-09-19" : ["people", "foundationDevelopment", "foundationFirstStep", "foundationQA"].includes(id) ? "2026-09-11" : "2026-09-10";
  const dateKey = date === "2026-09-19" ? "insights.publicationDateHaanel" : date === "2026-09-13" ? "insights.publicationDatePersonal" : date === "2026-09-11" ? "insights.publicationDatePeople" : "insights.publicationDate";
