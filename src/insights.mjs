...
export const insightsArticles = [
  ["haanelBiography", "2026-09-19"], ["powerWithin", "2026-09-19"],
...
export function renderInsightCard({ id, href, language = "en" }) {
  ...
  const pdfs = { personalCoaching: "advantages-personal-master-key-system-coaching.pdf", imagineMeditation: "imagine-combining-deep-meditation-personal-development.pdf", haanelBiography: "who-was-charles-f-haanel-life-and-legacy.pdf", powerWithin: "the-power-within-charles-haanel-foreword.pdf", foundationDevelopment: "foundation-stage-development.pdf", foundationFirstStep: "foundation-first-step.pdf", foundationQA: "foundation-stage-questions-and-answers.pdf", people: "10-people-connected-to-the-master-key-system.pdf", introduction: "charles-haanel-master-key-system-introduction.pdf", principles: "eight-principles-master-key-system.pdf", worldWithin: "world-within-and-world-without.pdf", journey: "master-key-system-24-week-journey.pdf", lawAttraction: "law-of-attraction-week-18.pdf" };
  const pdf = pdfs[id];
...
export function renderInsightsPreview({ language = "en", data = siteData } = {}) {
  const routeKeys = { haanelBiography: "insightsHaanelBiography", powerWithin: "insightsPowerWithin", personalCoaching: "insightsPersonalCoaching", imagineMeditation: "insightsImagineMeditation", foundationDevelopment: "insightsFoundationDevelopment", foundationFirstStep: "insightsFoundationFirstStep", foundationQA: "insightsFoundationQA", people: "insightsPeople", journey: "insightsJourney", lawAttraction: "insightsLawAttraction", introduction: "insightsIntroduction", principles: "insightsPrinciples", worldWithin: "insightsWorldWithin" };
