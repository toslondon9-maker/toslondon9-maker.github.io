...
export function renderInsightCard({ id, href, language = "en" }) {
  ...
  const number = { personalCoaching: "01", foundationDevelopment: "02", foundationFirstStep: "03", foundationQA: "04", people: "05", journey: "06", lawAttraction: "07", introduction: "08", principles: "09", worldWithin: "10" }[id];
  const pdfs = { personalCoaching: "advantages-personal-master-key-system-coaching.pdf", foundationDevelopment: "foundation-stage-development.pdf", foundationFirstStep: "foundation-first-step.pdf", foundationQA: "foundation-stage-questions-and-answers.pdf", people: "10-people-connected-to-the-master-key-system.pdf", introduction: "charles-haanel-master-key-system-introduction.pdf", principles: "eight-principles-master-key-system.pdf", worldWithin: "world-within-and-world-without.pdf", journey: "master-key-system-24-week-journey.pdf", lawAttraction: "law-of-attraction-week-18.pdf" };
  const pdf = pdfs[id];
  const date = id === "personalCoaching" ? "2026-09-13" : ["people", "foundationDevelopment", "foundationFirstStep", "foundationQA"].includes(id) ? "2026-09-11" : "2026-09-10";
