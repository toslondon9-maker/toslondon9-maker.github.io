...
export function renderInsightCard({ id, href, language = "en" }) {
  ...
  const pdf = id === "energyAttention" ? "energy-goes-where-attention-flows.pdf" : pdfs[id];
  const date = articleDates[id];
  const dateKey = date === "2026-09-26" ? "insights.publicationDateEnergyAttention" : date === "2026-09-25" ? "insights.publicationDateHowToStudy" : date === "2026-09-19" ? "insights.publicationDateHaanel" : date === "2026-09-13" ? "insights.publicationDatePersonal" : date === "2026-09-11" ? "insights.publicationDatePeople" : "insights.publicationDate";
