...
import { insightsJourneyPage, insightsLawAttractionPage, insightsPeoplePage, insightsFoundationDevelopmentPage, insightsFoundationFirstStepPage, insightsFoundationQAPage, insightsPersonalCoachingPage, insightsImagineMeditationPage } from "./pages/insights-source-article.mjs";
...
export const routeRenderers = Object.freeze({
  ...
  [siteData.routes.insightsFoundationDevelopment]: (data) => insightsFoundationDevelopmentPage(data),
  [siteData.routes.insightsFoundationFirstStep]: (data) => insightsFoundationFirstStepPage(data),
  [siteData.routes.insightsFoundationQA]: (data) => insightsFoundationQAPage(data),
