...
test("page shell cache-busts the release assets that control visible copy and layout", () => {
  ...
  assert.match(html, /src="\/assets\/site-language\.mjs\?v=20260909-insights-collection"/);
  assert.match(languageModule, /translations\.mjs\?v=20260909-insights-collection/);
});
