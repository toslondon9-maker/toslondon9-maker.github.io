...
const translations = deepFreeze({
  ...
  "home.hero.change": {
    en: "Build clarity, focus and purposeful action through Charles F. Haanel's Master Key System, interpreted for modern life and supported by practical coaching.",
  ...
  "home.cta.exploreJourney": { en: "Discover the Journey", es: "Descubre el recorrido" },
  ...
  "home.lineage.title": { en: "Three distinct roles in one learning journey", es: "Tres funciones distintas en un mismo recorrido de aprendizaje" },
  ...
  "home.lineage.haanel.body": { en: "Author of the original Master Key System and its progressive weekly lessons.", es: "Autor del Master Key System original y de sus lecciones semanales progresivas." },
  "home.lineage.helmar.name": { en: "Helmar Rudolph", es: "Helmar Rudolph" },
  "home.lineage.helmar.role": { en: "Interpretation & Application", es: "Interpretación y aplicación" },
  "home.lineage.helmar.body": { en: "A modern perspective that helps make the principles easier to study and apply.", es: "Una perspectiva actual que facilita el estudio y la aplicación de los principios." },
  "home.lineage.tariq.name": { en: "Tariq Saddique", es: "Tariq Saddique" },
  "home.lineage.tariq.role": { en: "Guidance & Coaching", es: "Guía y coaching" },
  "home.lineage.tariq.body": { en: "Practical support to help you turn insight into focused, purposeful action.", es: "Apoyo práctico para ayudarte a convertir lo aprendido en una acción enfocada y con propósito." },
  ...
  "route.home.heading": { en: "Master Your Mind. Change Your Direction.", es: "Domina tu mente. Cambia tu rumbo." },
  "route.home.purpose": {
    en: "A progressive journey inspired by timeless principles and designed for purposeful action in modern life.",
