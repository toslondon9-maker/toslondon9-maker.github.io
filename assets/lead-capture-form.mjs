...
export function localizeForm(form, language, documentRef = globalThis.document) {
  ...
  setText(documentRef, "[data-lead-capture-success] [data-lead-success-free]", copy.successFree);
  setText(documentRef, "[data-lead-capture-success] [data-lead-success-prompt]", copy.successPrompt);
  setText(documentRef, "[data-lead-capture-success] [data-lead-success-next-steps]", copy.successNextSteps);
  setText(documentRef, "[data-lead-capture-success] [data-lead-success-action]", copy.successAction);
  setText(documentRef, "[data-lead-capture-success] [data-lead-success-download]", copy.successDownload);
  setText(documentRef, "[data-lead-capture-success] [data-lead-success-whatsapp]", copy.successWhatsapp);
  setText(documentRef, "[data-lead-capture-success] [data-lead-success-note]", copy.successNote);
}
