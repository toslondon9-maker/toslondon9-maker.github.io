...
function setHref(root, selector, value) { const node = root?.querySelector?.(selector); if (node) node.setAttribute?.("href", value); }
...
export function localizeForm(form, language, documentRef = globalThis.document) {
  ...
  setHref(documentRef, "[data-lead-capture-success] [data-lead-success-whatsapp]", `https://wa.me/34611223345?text=${encodeURIComponent(copy.successWhatsappMessage)}`);
